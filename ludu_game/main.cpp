...
int drawaxes;
double angle;
double tx,a,movx,movy,up,cx,cy,r,l,tx1,ty;
...
glPushMatrix();
 ...
 glPushMatrix();
 {
    glTranslatef(35,35,11);
   drawCircle(4,10) ;
 }glPopMatrix();
 glPushMatrix();
 {
    glTranslatef(45,45,11);
   drawCircle(4,10) ;
 }glPopMatrix();

 glPushMatrix();
 {
    glTranslatef(45,35,11);
   drawCircle(4,10) ;
 }glPopMatrix();
 }glPopMatrix();
